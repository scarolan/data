  ...
  app.message(directMention(), async ({ message, say }) => {
    ...
    if (message.text && message.text.toLowerCase().includes('help')) {
      const commandsList = [
        ...
        'i love you  - Replies with “I know.”',
        'open the pod bay door - Classic sci-fi refusal with your display name',
        'danceparty - Random emoji dance party',
        'tiktok     - Party button',
        'rickroll   - Rick Astley button',
        '',
        '# Slash commands:',
        '/dalle <prompt> - Generate an image with DALL·E',
        '',
        `# Address the bot directly with @${process.env.SLACK_BOT_USER_NAME} syntax:`,
        `@${process.env.SLACK_BOT_USER_NAME} help      - Show this help message`,
        ...
        '',
        '# Direct messages and most other direct mentions fall back to ChatGPT.',
        '# If you ask for an image in chat, the bot will point you to /dalle.',
